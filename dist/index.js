...
const console_1 = __nccwpck_require__(82);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, console_1.assert)(commit_log === 'feat: add new module!');
            (0, console_1.assert)(style === 'angular');
            (0, console_1.assert)(scopes.toString() === '(empty)');
        }
        catch (error) {
